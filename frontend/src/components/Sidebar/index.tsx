  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between gap-2 px-6 py-5.5 lg:py-6.5">
        <NavLink
          to="/"
          className="flex item-center justify-center items-center"
        >
          <img src={Logo} alt="Logo" width={50} />
          <h3 className="text-white text-3xl">anageMe</h3>
        </NavLink>
          ...
          <div className="flex flex-col justify-between h-full">
            ...
            <ul className="flex flex-col gap-1.5">
              ...
              {isLoggedIn == false || isLoggedIn == undefined ? (
                ...
                <li>
                  <button
                    className={`relative flex w-full items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4`}
