    ...
    <div className="rounded-sm border border-stroke bg-white px-5 pt-6 pb-2.5 shadow-default dark:border-strokedark dark:bg-boxdark sm:px-7.5 xl:pb-1">
      ...
      <div className="flex flex-col ">
        ...
        {projects.length > 0 ? (
          ...
          <div className="grid grid-cols-3 sm:grid-cols-3 border-b border-stroke dark:border-strokedark">
            <div className="col-span-3 sm:col-span-4 flex items-center justify-center p-2.5 xl:p-5">
              <p className="text-black dark:text-white">No data</p>
            </div>
          </div>
        )}
      </div>
